...
class GPT(nn.Module):
    ...
    def forward(self, tensors, targets=None, attention_mask=None, is_training=False):
        ...
        if attention_mask is None:
            ...
            attention_mask = attention_mask.to(dtype=x.dtype)  # Chuyển đổi thành float để mở rộng
        ...
        # Chuẩn hóa lớp cuối cùng và đầu ra
        x = self.transformer.ln_f(x)
        logits = self.lm_head(x)

        # TODO: Di chuyển mất mát ra ngoài huấn luyện
        loss = None
